...
bool Adafruit_FONA::getGPS(float *lat, float *lon, float *speed_kph,
                           float *heading, float *altitude, uint8_t *Year, uint8_t *Month, uint8_t *Day, uint8_t *Hour, uint8_t *Minute, uint8_t *Second) {
  ...
  if (_type == FONA3G_A || _type == FONA3G_E) {
    ...
    *lon = atof(longp);
    ...
    static char date_[15];
    strncpy(date_, dategps, sizeof(date_)-1);
    ...
    static char year[2]= {date_[2],date_[3]};
    static char month[2]= {date_[4],date_[5]};
    static char day[2]= {date_[6],date_[7]};
    static char hour[2]= {date_[8],date_[9]};
    static char minute[2]= {date_[10],date_[11]};
    static char second[2]= {date_[12],date_[13]};
